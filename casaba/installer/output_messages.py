...
INFO_HEADER = "You are using casaba for deploying OpenStack %s" % basedefs.APP_NAME
INFO_INSTALL_SUCCESS = "\n **** OpenStack Installation have been done ******\n"
...
INFO_CHANGED_VALUE = ("Casaba changed given value %s to required "
                      "value %s")
WARN_VAL_IS_HOSTNAME = ("Warning: Casaba failed to change given "
